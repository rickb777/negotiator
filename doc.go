...
//
// A Negotiator contains a list of ResponseProcessor. For each call to Negotiate, one or more offers
// of possibly-matching data is compared with the headers in the request. The best matching
